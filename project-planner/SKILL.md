...
### 3. **Break Down Tasks**
- Each task: Estimated work hours
- Clear "done" criteria
...
**User Request:** "Plan a website redesign. Team: 1 designer, 2 developers. Deadline: 2 weeks."
...
| # | Milestone | Target Date | Owner | Success Criteria |
|---|-----------|-------------|-------|-------------------|
| 1 | Design Approved | End Week 1 | Designer | Stakeholders sign off on mockups |
| 2 | Development Complete | End Week 2 | Dev Team | All pages functional in staging |
| 3 | Launch | Week 3 | All | Site live, no critical bugs |
...
| Content not ready | Medium | Medium | Start content migration early (Week 2), use placeholders if needed |
| Technical issues | Medium | Low | Leave buffer in Week 2, have backup plan for hosting |
...
|------|------------|--------------|----------------------|
| Designer | 20h | Week 1 | Design, stakeholder management, UAT |
| Developer 1 | 20h | Weeks 1-2 | Architecture, dev setup, page development |
| Developer 2 | 20h | Weeks 1-2 | CMS, page development, testing |

**Total Effort**: ~60 hours across 2 weeks
...
- **Weeks 1, 2**: Milestone reviews with stakeholders

---

## Success Metrics

- Launch on time (Week 3)
