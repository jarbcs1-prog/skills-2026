...
|--------|------------|---------|
| AI disclosure | When content is AI-generated | "This page was created with AI assistance" |
| Human review badge | When content is fact-checked by humans | "Fact-checked by our editorial team" |
| Data freshness | When information freshness matters | "Last updated: August 2026" |
...
|---------|------|---------|
| 2.0.0 | 2026-07-30 | Added trigger conditions, AI transparency signals, trust signal priority matrix, anti-patterns, diagnostic decision tree, modern trust contexts (regulated, open-source, sustainability), cross-skill references, quick reference checklist |
