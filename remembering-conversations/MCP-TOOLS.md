...
Search your episodic memory of past agent conversations using semantic or text search.
...
```typescript
{
  path: "/Users/User/.config/superpowers/conversation-archive/project/uuid.jsonl"
}
```
