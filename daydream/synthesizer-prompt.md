...
Your task is to find deep, non-obvious and potentially groundbreaking connections between two notes.

Do NOT state the obvious. Generate insights that the note author would find surprising and valuable.
